...
class ProductServiceImplTest {
	...
	void testAddProducts() {
		Product product = new Product(1,"watch","watch","Electronic", null, null, "abc.jpg", "bcd.jpg", 0, "description", null);
	...
	void testGetAllProducts() {
		...
		.thenReturn(Stream.of(new Product(1,"Rolex watch","watch","Electronic", null, null, "abc.jpg", "bcd.jpg", 0, "description", null),new Product(1,"Dell ","laptop","Electronic", null, null, "abc.jpg", "bcd.jpg", 0, "description", null)).collect(Collectors.toList()));
